...
namespace Do_an_mon_hoc.Controllers
{
    ...
    public class CategoryGroupApiController : ControllerBase
    {
        ...
        public async Task<ActionResult<IEnumerable<CategoryGroupDTO_Get>>> GetCategoryGroups()
        {
            ...
            var convertedCategories = _mapper.Map<IEnumerable<CategoryDTO_Get>>(category_group);
        ...
        public async Task<ActionResult<IEnumerable<CategoryGroupDTO_GetCategories>>> GetCategories(int categoryGroupId)
        {
            ...
            var convertedCategories = _mapper.Map<IEnumerable<CategoryGroupDTO_GetCategories>>(categoryGroup);
        ...
        public async Task<ActionResult<IEnumerable<CategoryGroupDTO_GetProducts>>> GetCategoriesGroupProducts()
        {
            try
            {
                ...
                var categoryGroupDtos = categoryGroups
                    .Select(cg => _mapper.Map<CategoryGroupDTO_GetProducts>(cg))
                    .ToList();
